...
export default function App() {
  ...
  // New state for tracking add/edit employee loading
  ...
  return (
    <div className="App">
      ...
      {/* Show add/edit employee loading overlay */}
      {isAddingEmployee && (
        <div className="loading-overlay">
          <div className="loading-content">
            <div className="spinner"></div>
            <p>{isEditingEmployee ? 'Updating employee...' : 'Adding new employee...'}</p>
          </div>
        </div>
      )}
      ...
      {editingEmployee && (
        <EmployeeEditor
          ...
          isLoading={isAddingEmployee} // Pass loading state to EmployeeEditor
        />
      )}
      {editingEvent && (
        <EventEditor
